    ...
    return (
        <>
            <div className={myStyles.container}>
                <h2 className={myStyles.section_title}>Faculty Members</h2>

                <div className={myStyles.container}>
                    <h2 className={myStyles.section_title}>Bachelors in Arts</h2>
                ...
                <div className={myStyles.container}>
                    <h2 className={myStyles.section_title}>Bachelors in Science</h2>
                    <div className={myStyles.teaching_staffs}>
                        <div className={myStyles.staffs}>
                ...
                <div className={myStyles.container}>
                    <h2 className={myStyles.section_title}>Bachelors in Commerce</h2>
                    <div className={myStyles.teaching_staffs}>
                        <div className={myStyles.staffs}>
                            <h5>DR. GAUTAM DAS</h5>
                            <div className={myStyles.details}>

...
export function Otherlinks() {
    return (
      <div className={myStyles.container}>
        ...
        <div className={myStyles.staffs}>
          <h5>IQAC</h5>
          <p><Link to="/iqac">Visit IQAC</Link></p>
        </div>
        <div className={myStyles.staffs}>
        ...
        <div className={myStyles.staffs}>
          <h5>Activities</h5>
          <p><Link to="/activities">Visit Activities</Link></p>
        </div>
        <div className={myStyles.staffs}>
          <h5>Alumni</h5>
          <p><Link to="/alumni">Visit Alumni</Link></p>
        </div>
        <div className={myStyles.staffs}>
          <h5>Feedback</h5>
          <p><Link to="/feedback">Visit Feedback</Link></p>
        </div>
        <div className={myStyles.staffs}>
          <h5>Image Gallery</h5>
          <p><Link to="/imagegallery">Visit Image Gallery</Link></p>
        </div>
        <div className={myStyles.staffs}>
        ...
        <div className={myStyles.staffs}>
          <h5>Library</h5>
          <p><Link to="/library">Visit Library</Link></p>
        </div>
        <div className={myStyles.staffs}>
          <h5>OPAC</h5>
        ...
        <div className={myStyles.staffs}>
          <h5>RTI</h5>
          <p><Link to="/rti">Visit RTI</Link></p>
        </div>
        <div className={myStyles.staffs}>
          <h5>NIRF</h5>
          <p><Link to="/nirf">Visit NIRF</Link></p>
        </div>
        </div>
      </div>
    )
